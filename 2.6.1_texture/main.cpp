...
#endif
{
	...
	auto window = glfwCreateWindow(800, 600, "2.6.1 Texture", nullptr, nullptr);
...
;
	...
	glsl::Program prog{
		{ glsl::vertex_shader  , "resources/shaders/2.6.1_texture.vs"s },
		{ glsl::fragment_shader, "resources/shaders/2.6.1_texture.fs"s }
	};
